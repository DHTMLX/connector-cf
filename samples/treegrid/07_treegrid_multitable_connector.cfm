...
<cfset tree = createObject("component",request.dhtmlxConnectors["treegrid_multitable"]).init(request.dhtmlxConnectors["datasource"],request.dhtmlxConnectors["db_type"])>
<!---
